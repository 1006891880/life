...
import com.android.dialoglibrary.dialogFragment.BaseDialogFragment;
...
public class DialogMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showPopupWindow1() {
        View contentView = LayoutInflater.from(this).inflate(R.layout.pop_layout_dialog,null);
    ...
    private void showCustomDialog2() {
        final TestCustomDialogFragment dialog = new TestCustomDialogFragment();
        ...
        dialog.setCancelListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TestCustomDialogFragment.dismissDialogFragment();

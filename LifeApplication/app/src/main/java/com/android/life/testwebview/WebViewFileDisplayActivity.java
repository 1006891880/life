...
import com.android.webviewlibrary.FileReaderView;
...
public class WebViewFileDisplayActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_file_display_webview);
        copy();
        init();
    }
    ...
    public void init() {
        ...
        findViewById(R.id.tv_start).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // 弹出保存图片的对话框
                new AlertDialog.Builder(WebViewFileDisplayActivity.this)

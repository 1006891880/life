package com.android.utilslibrary.switchButton
...
class SwitchButton : View, Checkable {
    ...
    companion object {
        private val DEFAULT_WIDTH: Int = dp2pxInt(45f)
        private val DEFAULT_HEIGHT: Int = dp2pxInt(30f)
        /** */
